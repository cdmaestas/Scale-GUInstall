...
- Dashboard summary tag built on the same local history: **Install Service: Run** (green) if setup has succeeded at least once for any installer IP in this browser, **Not Run** (red) otherwise.
